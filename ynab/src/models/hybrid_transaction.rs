...
impl HybridTransaction {
    pub fn new(id: String, date: String, amount: i64, cleared: crate::models::TransactionClearedStatus, approved: bool, account_id: uuid::Uuid, deleted: bool, r#type: Type, account_name: String) -> HybridTransaction {
        HybridTransaction {
            id,
            date,
            amount,
