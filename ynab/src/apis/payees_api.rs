...
/// struct for passing parameters to the method [`get_payee_by_id`]
#[derive(Clone, Debug)]
pub struct GetPayeeByIdParams {
...
/// struct for passing parameters to the method [`get_payees`]
#[derive(Clone, Debug)]
pub struct GetPayeesParams {
    /// The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).
    pub budget_id: String,
...
pub async fn get_payee_by_id(configuration: &configuration::Configuration, params: GetPayeeByIdParams) -> Result<crate::models::PayeeResponse, Error<GetPayeeByIdError>> {
...
/// Returns all payees
pub async fn get_payees(configuration: &configuration::Configuration, params: GetPayeesParams) -> Result<crate::models::PayeesResponse, Error<GetPayeesError>> {
    let local_var_configuration = configuration;
