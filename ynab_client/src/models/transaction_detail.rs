...
pub struct TransactionDetail {
    ...
    pub flag_color: Option<Option<crate::models::TransactionFlagColor>>,
...
impl TransactionDetail {
    pub fn new(id: String, date: String, amount: i64, cleared: crate::models::TransactionClearedStatus, approved: bool, account_id: uuid::Uuid, deleted: bool, account_name: String, subtransactions: Vec<crate::models::SubTransaction>) -> TransactionDetail {
        TransactionDetail {
            id,
            date,
            amount,
