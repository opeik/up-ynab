...
impl TransactionSummary {
    pub fn new(id: String, date: String, amount: i64, cleared: crate::models::TransactionClearedStatus, approved: bool, account_id: uuid::Uuid, deleted: bool) -> TransactionSummary {
        TransactionSummary {
            id,
            date,
            amount,
