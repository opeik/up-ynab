...
impl Account {
    pub fn new(id: uuid::Uuid, name: String, r#type: crate::models::AccountType, on_budget: bool, closed: bool, balance: i64, cleared_balance: i64, uncleared_balance: i64, transfer_payee_id: Option<uuid::Uuid>, deleted: bool) -> Account {
        Account {
            id,
            name,
            r#type,
