...
pub struct ListAccountsResponse {
    ...
    #[serde(rename = "data")]
    pub data: Vec<crate::models::AccountResource>,
    #[serde(rename = "links")]
...
impl ListAccountsResponse {
    ...
    pub fn new(data: Vec<crate::models::AccountResource>, links: crate::models::ListAccountsResponseLinks) -> ListAccountsResponse {
