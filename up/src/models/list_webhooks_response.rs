...
pub struct ListWebhooksResponse {
    ...
    #[serde(rename = "data")]
    pub data: Vec<crate::models::WebhookResource>,
    #[serde(rename = "links")]
...
impl ListWebhooksResponse {
    ...
    pub fn new(data: Vec<crate::models::WebhookResource>, links: crate::models::ListAccountsResponseLinks) -> ListWebhooksResponse {
