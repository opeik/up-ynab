...
pub struct RoundUpObjectBoostPortion {
...
impl RoundUpObjectBoostPortion {
    ...
    pub fn new(currency_code: String, value: String, value_in_base_units: i32) -> RoundUpObjectBoostPortion {
