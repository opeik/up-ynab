...
pub struct CategoryResourceRelationshipsParent {
...
impl CategoryResourceRelationshipsParent {
    pub fn new(data: Option<crate::models::CategoryResourceRelationshipsParentData>) -> CategoryResourceRelationshipsParent {
